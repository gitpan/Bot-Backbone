...
BEGIN {
  $Bot::Backbone::Dispatcher::Predicate::VERSION = '0.112320';
}
use v5.10;
use Moose;
...
BEGIN {
  $Bot::Backbone::Dispatcher::Predicate::RedispatchTo::VERSION = '0.112320';
}
    use v5.10;
    use Moose;
...
BEGIN {
  $Bot::Backbone::Dispatcher::Predicate::Nesting::VERSION = '0.112320';
}
    use v5.10;
    use Moose;
...
BEGIN {
  $Bot::Backbone::Dispatcher::Predicate::Command::VERSION = '0.112320';
}
    use v5.10;
    use Moose;
...
BEGIN {
  $Bot::Backbone::Dispatcher::Predicate::NotCommand::VERSION = '0.112320';
}
    use v5.10;
    use Moose;
...
BEGIN {
  $Bot::Backbone::Dispatcher::Predicate::ToMe::VERSION = '0.112320';
}
    use v5.10;
    use Moose;
...
BEGIN {
  $Bot::Backbone::Dispatcher::Predicate::GivenParameters::VERSION = '0.112320';
}
    use v5.10;
    use Moose;
...
BEGIN {
  $Bot::Backbone::Dispatcher::Predicate::Functor::VERSION = '0.112320';
}
    use v5.10;
    use Moose;
...
BEGIN {
  $Bot::Backbone::Dispatcher::Predicate::Respond::VERSION = '0.112320';
}
    use v5.10;
    use Moose;
...
BEGIN {
  $Bot::Backbone::Dispatcher::Predicate::Run::VERSION = '0.112320';
}
    use v5.10;
    use Moose;
